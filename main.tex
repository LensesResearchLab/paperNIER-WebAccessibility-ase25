...
% * Rework Sections 1–5 into two sections: (A) Introduction (motivation + objectives) and (B) Related work / State of the art (include automated testing).
% TODO Tighten writing and terminology consistency: remove redundancy, ensure consistent use of terms (agent, perceptual filter, screen reader), and fix organizational clarity across sections.
