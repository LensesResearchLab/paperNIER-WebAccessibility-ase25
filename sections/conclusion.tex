...
% TODO Maybe add a short paragraph on practical implications: when the tool can replace or complement user testing and the scenarios where human studies remain necessary