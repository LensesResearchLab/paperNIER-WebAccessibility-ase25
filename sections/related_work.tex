...
%? aquí se hace un cambio de la forma en la que se hacen las citas
...
Tools such as WAVE by WebAIM\cite{webaim_wave_2025} and IBM's NPM accessibility-checker\cite{ibm_accessibility_checker_2025} exemplify this approach. %? aquí se separan las citas
